...
from event.views import (
    ...
    ResultDetailViewPrivate, ResultUpdateViewPrivate, ResultDeleteViewPrivate, view_leader_board
)
...
urlpatterns = [
    ...
    path('member/result/leader_board/', view_leader_board, name='member_result_leader_board'),
